...
# Entities that should be exluded from the merging to a variable and value cloumn
dfprvarsstay<-c("Station","Campaign","UpperDepth","LowerDepth","MidDepth") 
dfflvarsstay<-c("Station","Campaign")                                     
...
##Plot subset of nutrient data
 ...
 pdf(paste0(plotdir,"/ProfileData1a.pdf"))
 G2
 dev.off()
