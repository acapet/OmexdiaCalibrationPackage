...
```
#Station
```{r Map, echo=FALSE, warning=FALSE, fig.height=4}
...
print(gmap+ggtitle(dfStations$Date))
...
Simplot(Parlist,TRUE,runnames = runnames, YL=max(dfProfiles$LowerDepth))+ggtitle(paste(sta,"_",cam,"1"))
```
